...
namespace RVO
{
    ...
    public class Simulator
    {
         ...
         * </remarks>
         */
        public int addObstacle(IList<KInt2> vertices)
        {
            if (vertices.Count < 2)
            {
                return -1;
        ...
        public KInt ClosedEdgeDist(int agentNo)
        {
            Agent agent = agents_[agentNo2indexDict_[agentNo]];
            if(agent.obstacleNeighbors_.Count >0)
            {
        ...
        {
            Agent agent = agents_[agentNo2indexDict_[agentNo]];
            return agent.obstacleNeighbors_.Count > 0 && agent.obstacleNeighbors_[0].Key.IntValue < (agent.radius_ * (agent.radius_  + agent.radius_ / 10) * KInt.divscale);
        }
         ...
         * to be retrieved.</param>
         */
        public KInt getAgentMaxSpeed(int agentNo)
        {
         ...
         */
        public KInt getAgentNeighborDist(int agentNo)
        {
         ...
         * retrieved.</param>
         */
        public KInt getAgentRadius(int agentNo)
        {
         ...
         * to be retrieved.</param>
         */
        public KInt getAgentTimeHorizon(int agentNo)
        {
         ...
         */
        public KInt getAgentTimeHorizonObst(int agentNo)
        {
         ...
         * retrieved.</param>
         */
        public KInt2 getObstacleVertex(int vertexNo)
        {
         ...
         * </param>
         */
        public void setAgentRadius(int agentNo, KInt radius)
        {
         ...
         */
        public void setAgentTimeHorizon(int agentNo, KInt timeHorizon)
        {
         ...
         */
        public void setAgentTimeHorizonObst(int agentNo, KInt timeHorizonObst)
        {
         ...
         */
        public void setGlobalTime(KInt globalTime)
        {
         ...
         * positive.</param>
         */
        public void setTimeStep(KInt timeStep)
        {
            timeStep_ = timeStep;
        }
