...
namespace TrueSync
{
    ...
    public struct TSMatrix4x4
    {
        ...
        public TSMatrix4x4(long m11, long m12, long m13, long m14,
        ...
        public static TSMatrix4x4 Multiply(TSMatrix4x4 matrix1, long scaleFactor)
        {
            TSMatrix4x4 result;
        ...
        public static void Multiply(ref TSMatrix4x4 matrix1, long scaleFactor, out TSMatrix4x4 result)
        {
        ...
        {
            TSMatrix4x4 result;
            TSMatrix4x4.Multiply(ref value2, -1, out value2);
            TSMatrix4x4.Add(ref value1, ref value2, out result);
            return result;
        }
        ...
        public static TSMatrix4x4 Translate(long xPosition, long yPosition, long zPosition)
        {
            TSMatrix4x4 result;
        ...
        public static TSMatrix4x4 Translate(Int3 translation)
        {
        ...
        public static TSMatrix4x4 Scale(long xScale, long yScale, long zScale)
        {
            TSMatrix4x4 result;
        ...
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(long xScale, long yScale, long zScale, Int3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(Int3 scales)
        {
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(Int3 scales, Int3 centerPoint)
        {
        ...
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(long scale)
        {
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(long scale, Int3 centerPoint)
        {
        ...
        /*public static TSMatrix4x4 RotateX(long radians)
        {
            TSMatrix4x4 result;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        /*public static TSMatrix4x4 RotateX(long radians, Int3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        /// <returns>The rotation matrix.</returns>
        /*public static TSMatrix4x4 RotateY(long radians)
        {
            TSMatrix4x4 result;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        /*public static TSMatrix4x4 RotateY(long radians, Int3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        /// <returns>The rotation matrix.</returns>
        /*public static TSMatrix4x4 RotateZ(long radians)
        {
            TSMatrix4x4 result;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        /*public static TSMatrix4x4 RotateZ(long radians, Int3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        /*public static void AxisAngle(ref Int3 axis, long angle, out TSMatrix4x4 result)
        {
            // a: angle
        ...
        /*public static TSMatrix4x4 AngleAxis(long angle, Int3 axis)
        {
            TSMatrix4x4 result;
        ...
        public static void TRS(Int3 translation, TSQuaternion rotation, Int3 scale, out TSMatrix4x4 matrix)
        {
            matrix = TSMatrix4x4.Translate(translation) * TSMatrix4x4.Rotate(rotation) * TSMatrix4x4.Scale(scale);
        }

        public static TSMatrix4x4 TRS(Int3 translation, TSQuaternion rotation, Int3 scale)
        {
            TSMatrix4x4 result;
