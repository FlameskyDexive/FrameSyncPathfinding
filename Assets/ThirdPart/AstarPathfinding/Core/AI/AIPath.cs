    ...
    public partial class AIPath : AIBase, IAstarAI
    {
        ...
        public float remainingDistance
        {
            get
            {
                ...
                return interpolator.valid ? interpolator.remainingDistance + movementPlane.ToPlane((Vector3)interpolator.position - position).magnitude : float.PositiveInfinity;
            }
        }
        ...
        public Vector3 steeringTarget
        {
            get
            {
                ...
                return interpolator.valid ? (Vector3)interpolator.position : position;
            }
        }
        ...
        protected override Vector3 ClampToNavmesh(Vector3 position, out bool positionChanged)
        {
            if (constrainInsideGraph)
            {
                ...
                var difference = movementPlane.ToPlane((Vector3)clampedPosition - position);
