...
namespace Pathfinding {
	...
	public class TriangleMeshNode : MeshNode {
        ...
        internal VInt3 ClosestPointOnNodeXZInGraphSpace (VInt3 p) {
            ...
            //Good Game
            //var closest = Pathfinding.Polygon.ClosestPointOnTriangleXZ(a, b, c, p);
            //var closest = Pathfinding.Polygon.ClosestPointOnTriangleXZ((Vector3)a, (Vector3)b, (Vector3)c, (Vector3)p);
			...
			if (ContainsPointInGraphSpace(i3closest)) {
			    ...
			    //Debug.Log("--ClosestPointOnNodeXZInGraphSpace--" + (da < db ? (da < dc ? a : c) : (db < dc ? b : c)).ToString());
