...
namespace Pathfinding {
	...
	public struct Int3 : System.IEquatable<Int3> {
		...
		public static long DotLongSafe (Int3 lhs, Int3 rhs) {
			return
				((long)lhs.x * (long)rhs.x +
				(long)lhs.y * (long)rhs.y +
	    ...
	    /// <param name="a"></param>
	    /// <param name="b"></param>
	    public static long Distance(Int3 a, Int3 b)
	    {
        ...
        public Int3 RotateY(ref VFactor radians)
        {
            ...
            Int3 int3;
            int3.x = (int)IntMath.Divide((long)this.x * num + (long)this.z * num2, b);
            int3.z = (int)IntMath.Divide(-(long)this.x * num2 + (long)this.z * num, b);
            int3.y = 0;
            return int3.NormalizeTo(1000);
        }
